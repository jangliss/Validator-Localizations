// ==UserScript==
// @name                WME Validator Localization for Nevada
// @namespace           https://greasyfork.org/users/6605
// @version             1.1.10
// @author              crazycaveman
// @description         This script localizes WME Validator for Nevada, USA. You also need main package (WME Validator) installed.
...
window.WME_Validator_United_States = {
  ...
  "130.params": {
    ...
    "problemEN": "All state highways should be named NV-### in Nevada",
    "solutionEN": "Change name to NV-### (if it is truly a state highway)",
    "template": "${state}:#${street}#${altStreet[#]}",
    "regexp": "/^Nevada:.*\\b(?:State (Hwy|R(ou)?te)|S[HR]-)\\b/i"
  },
