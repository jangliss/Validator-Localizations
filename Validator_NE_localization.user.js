...
window.WME_Validator_United_States = {
  ...
  "130.params": {
    ...
    "problemEN": "All state highways should be named NE-### in Nebraska",
    "solutionEN": "Change name to NE-### (if it is truly a state highway)",
    "template": "${state}:#${street}#${altStreet[#]}",
    "regexp": "/^Nebraska:.*\\b(State Hwy |S[HhRr][- =])[0-9]{1,3}/"
  },
