// ==UserScript==
// @name                WME Validator Localization for New Hampshire
// @namespace           https://greasyfork.org/users/6605
// @version             1.1.10
// @author              crazycaveman
// @description         This script localizes WME Validator for New Hampshire, USA. You also need main package (WME Validator) installed.
...
window.WME_Validator_United_States = {
  ...
  "130.params": {
    ...
    "problemEN": "All state highways should be named State Hwy ### in New Hampshire",
    "solutionEN": "Change name to State Hwy ### (if it is truly a state highway)",
    "template": "${state}:#${street}#${altStreet[#]}",
    "regexp": "/^New Hampshire:.*\\b(?:State R(ou)?te|S[HR]-)\\b/i"
  },
