// ==UserScript==
// @name                WME Validator Localization for Kansas
// @namespace           https://greasyfork.org/users/6605
// @version             1.1.8
// @author              crazycaveman
// @description         This script localizes WME Validator for Kansas, USA. You also need main package (WME Validator) installed.
...
window.WME_Validator_United_States = {
  ...
  "130.params": {
    ...
    "problemEN": "All state highways should be named K-### in Kansas",
    "solutionEN": "Change name to K-### (if it is truly a state highway)",
    "template": "${state}:#${street}#${altStreet[#]}",
    "regexp": "/^Kansas:.*\\b(State Hwy |S[HhRr][- =])[0-9]{1,3}/"
  },
