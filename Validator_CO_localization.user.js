// ==UserScript==
// @name                WME Validator Localization for Colorado
// @namespace           https://greasyfork.org/users/6605
// @version             1.1.10
// @author              crazycaveman
// @description         This script localizes WME Validator for Colorado, USA. You also need main package (WME Validator) installed.
...
window.WME_Validator_United_States = {
  ...
  "130.params": {
    ...
    "problemEN": "All state highways should be named SH-### in Colorado",
    "solutionEN": "Change name to SH-### (if it is truly a state highway)",
    "template": "${state}:#${street}#${altStreet[#]}",
    "regexp": "/^Colorado:.*\\b(?:State (Hwy|R(ou)?te)|SR-)\\b/i"
  },
