// ==UserScript==
// @name                WME Validator Localization for Vermont
...
window.WME_Validator_United_States = {
  ...
  "130.params": {
    ...
    "problemEN": "All state highways should be named VT-### in Vermont",
    "solutionEN": "Change name to VT-### (if it is truly a state highway)",
    "template": "${state}:#${street}#${altStreet[#]}",
    "regexp": "/^Vermont:.*\\b(?:State (Hwy|R(ou)?te)|S[HR]-)\\b/i"
  },
