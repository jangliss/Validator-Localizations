// ==UserScript==
// @name                WME Validator Localization for New York
// @namespace           https://greasyfork.org/users/6605
// @version             1.1.7
// @author              crazycaveman
// @description         This script localizes WME Validator for New York, USA. You also need main package (WME Validator) installed.
...
window.WME_Validator_United_States = {
  ...
  "130.params": {
    ...
    "problemEN": "All state highways should be named NY-### in New York",
    "solutionEN": "Change name to NY-### (if it is truly a state highway)",
