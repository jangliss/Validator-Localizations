// ==UserScript==
// @name                WME Validator Localization for North Dakota
// @namespace           https://greasyfork.org/users/6605
// @version             1.1.8
// @author              crazycaveman
// @description         This script localizes WME Validator for North Dakota, USA. You also need main package (WME Validator) installed.
...
window.WME_Validator_United_States = {
  ".country": "North Dakota, United States",
  ".codeISO": "US",
  ".author": "crazycaveman",
  ".updated": "2015-10-19",
  ".link": "",
  ...
  "130.params": {
    ...
    "problemEN": "All state highways should be named ND-### in North Dakota",
    "solutionEN": "Change name to ND-### (if it is truly a state highway)",
    "template": "${state}:#${street}#${altStreet[#]}",
    "regexp": "/^North Dakota:.*\\b(State Hwy |S[HhRr][- =])[0-9]{1,3}/"
  },
