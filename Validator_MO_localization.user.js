// ==UserScript==
// @name                WME Validator Localization for Missouri
// @namespace           https://greasyfork.org/users/6605
// @version             1.1.8
// @author              crazycaveman
// @description         This script localizes WME Validator for Missouri, USA. You also need main package (WME Validator) installed.
...
window.WME_Validator_United_States = {
  ...
  "130.params": {
    ...
    "problemEN": "All state highways should be named MO-### in Missouri",
    "solutionEN": "Change name to MO-### (if it is truly a state highway)",
    "template": "${state}:#${street}#${altStreet[#]}",
    "regexp": "/^Missouri:.*\\b(State Hwy |S[HhRr][- =])[0-9]{1,3}/"
  },
  ...
  "135.enabled": true,
  "135.params": {
    "titleEN": "Wrong name for supplementary state highway",
    "problemEN": "All supplementary state highways should be named SH-xx in Missouri",
    "solutionEN": "Change name to SH-xx (if it is truly a supplementary highway)",
    "template": "${state}:#${street}#${altStreet[#]}",
    "regexp": "/^Missouri:.*\\b(State Hwy |(S[hRr]|MO)[- =])[A-Z]+/"
  },
  "135.solutionLink": "W:Highway_naming/USA",
  //Freeway lock
  "150.enabled": true,
  "150.params": {
